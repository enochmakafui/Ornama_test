...
class ClientSectionView {
  render() {
    return `<section class="client  bg-white mt-8 md:mt-[210px] py-[40px] md:py-[97px] flex flex-col justify-center items-center px-5 md:px-20">
    <div class="section section--hidden client_section rotate">
        ...
        <p class="text-center text-xl md:text-2xl mt-2 md:mt-[20px]"> We have been privileged to work with some of these awesome brands</p>
            ...
            <div class="client-images-container grid grid-cols-2 md:grid-cols-3 mx-2 md:mx-20  gap-x-8 md:gap-x-[87px] gap-y-8 md:gap-y-16 mt-3 md:mt-16">
