    ...
    <section class="client client__heading  bg-white mt-8 md:mt-[150px] py-[40px] md:py-[97px] flex flex-col justify-center items-center px-5 md:px-20">
      <div class="section section--hidden client_section rotate">
        <div>
          ...
          <div class="client-images-container grid grid-cols-2 md:grid-cols-3 mx-2 md:mx-20  gap-x-8 md:gap-x-[80px] gap-y-8 md:gap-y-16 mt-3 md:mt-16">
                <div class="client-image-card  flex justify-center items-center">
