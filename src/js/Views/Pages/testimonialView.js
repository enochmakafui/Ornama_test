...
class TestimonialView {
    ...
    .map(() => {
      return `<div class="swiper-slide">
                        <div class="testimonial-card bg-[#121212] py-[24px] md:py-8 px-[24px] md:px-12 rounded-2xl">
                            <h3 class="mb-2 md:mb-8  bg-[#000000] uppercase px-[24px] py-[12px] rounded-[20px] w-max">Testimonials</h3>
                            <h2 class="text-2xl md:text-[56px] mb-4">What our clients <span class="italic font-semibold text-[#ff7e21] said">said</span></h2>
                            ...
                            <div class="profile flex items-center gap-4 mt-4 md:mt-5">
                                <img src=${avatarImage} alt="profile image" class="w-[60px] md:w-[100px] h-[60px] md:h-[100px]"/>
                                <div class="profile-about ">
                                <p class="head text-xl md:text-2xl">Jonathan Mensah</p>
                                <p class="role  md:text-xl ">CEO of ReHome Africa</p>
                            </div>
                        </div>
                        </div>
                </div>`;
  ...
  render() {
    return `
        <div class="testimonial px-5 md:px-0">
