...
class Cal2CarePageView extends View {
  _generateMarkup() {
    return `
    <div class="bg-white text-[color:#343a40] px-5 md:px-[100px] lg:px-[auto] pt-8 md:pt-[38px] pb-[100px]">
        <section class="">
            <div >
        ...
        <section class="mt-8 md:mt-[100px] flex flex-col md:flex-row px-2 md:px-16">
            <div class="basis-2/4">
                ...
                <ul>
                    <li class="mb-2"><span class="font-bold">Uniqueness:</span> The client's previous logo was similar to others in the industry, lacking a unique identity that set them apart. Color Scheme: The old color scheme failed to clearly represent the company’s values of trust, unity, and care. Icon Misinterpretation: The "call" icon in the previous logo was often mistaken for a phone call, rather than symbolizing a natural calling to care as an ethos.</li>
                    <li>
                    </li>
                    <li class="mb-2"><span class="font-bold">Color Scheme:</span> The old color scheme failed to clearly represent the company’s values of trust, unity, and care.</li>
                    <li><span class="font-bold">Icon Misinterpretation:</span> The "call" icon in the previous logo was often mistaken for a phone call, rather than symbolizing a natural calling to care as an ethos</li>
                </ul>
            </div>
            <div class="basis-2/4">
        ...
        <section class="mt-8 md:mt-[100px]">
            <div >
                <img src="${twoPostersSideBySide}" alt="" class="rounded-[11px] md:rounded-[40px]"/>
            </div>
        </section>
        <section class="mt-8 md:mt-[100px]">
            <div >
                <img src="${lotOfPostersImages}" alt="" class="rounded-[11px] md:rounded-[40px]"/>
            </div>
        </section>
