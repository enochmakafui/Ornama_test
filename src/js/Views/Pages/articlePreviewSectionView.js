...
class ArticlePreviewSectionView {
  render() {
    return `
   <section class="mx-5 md:mx-[80px] lg:mx-[auto] pt-[64px] md:pt-[137px] pb-1 md:pb-[68px] px-3 md:px-10 section section--hidden article_section lg:max-w-[1440px]">
    <div>
        <h2 class="text-white section-heading text-center text-2xl md:text-5xl tracking-[0.8px] ">More Articles</h2>
    </div>
    <div class="flex  flex-col md:flex-row justify-between gap-[20px]  mt-[40px] md:mt-[64px]">
        <figure class="w-full md:w-auto hover:scale-105 transition-all duration-300 ease-in-out mb-10 md:mb-0">
