  ...
  _generateMarkup() {
    ...
    <div class="bg-white text-[color:#343a40] px-2 md:px-20 pt-8 md:pt-[211px] pb-16">
        ...
        <section class="mt-8 md:mt-[100px] flex flex-col md:flex-row items-center px-2 md:px-16">
            <div class="basis-2/4">
                <h2 class="text-5xl  mb-8 devron-solution-text">Devron Nexus </br> Solutions</h2>
        ...
        <section class="mt-8 md:mt-[100px]">
         ...
         <section class="mt-8 md:mt-[100px] flex flex-col md:flex-row  px-2  md:px-16">
            <div class="basis-2/4">
                <h2 class="text-5xl mb-8 devron-solution-text">The Mark of </br> Devron Nexus</h2>
            </div>
            <div class="basis-2/4">
        ...
        <section class="mt-8 md:mt-[100px] flex flex-col md:flex-row px-2 md:px-16">
            ...
            <div class="basis-2/4">
                <div>
                <h2 class="text-5xl mb-8 devron-solution-text">The Nexus </br> Effect</h2>
                </div>
        ...
        <section class="mt-8 md:mt-[100px] flex flex-col md:flex-row px-2 md:px-16">
            <div class="basis-2/4">
                <h2 class="text-5xl  mb-8 devron-solution-text">A Symphony of </br> Services</h2>
            </div>
            <div class="basis-2/4">
