...
class DevronNexusPageView extends View {
  _generateMarkup() {
    ...
    <div class="bg-white px-2 md:px-20 pt-8 md:pt-16 pb-16">
        <section class="">
            <div >
                <img src="${topBannerImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        ...
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${threeLogosAndArrowImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
         <section class="mt-8 md:mt-16 flex flex-col md:flex-row px-2  md:px-16">
            <div class="basis-2/4">
        ...
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${fourSideBySideImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
    
         <section class="flex justify-center mt-8 md:mt-16">
            <div >
        ...
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${threeTypeFacesAndCurvedLogoImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
            <div >
        ...
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${typeFaceImageBlack}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${ladyAndGuyImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${ladyImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${bookAndShirtImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${planeImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
            <div >
                <img src="${carImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
        <section class="mt-8 md:mt-16">
        ...
        <section class="mt-8 md:mt-16 flex flex-col md:flex-row px-2 md:px-16">
         ...
         <section class="mt-8 md:mt-16">
            <div >
                <img src="${parcelImage}" alt="" class="rounded-2xl"/>
            </div>
        </section>
    </div>
        `;
