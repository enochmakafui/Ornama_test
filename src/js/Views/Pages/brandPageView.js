...
class BrandPageView extends View {
  _generateMarkup() {
    return `
         <div class="bg-[#121212]">
            <section class="hero  text-white mx-5 md:mx-[80px] lg:mx-[auto] md:px-10  mt-8 md:pt-[210px]">
            ...
            <section >
                ...
                <a href="/branding/careBrand" data-route="/branding/careBrand" class="relative ">
                    <div class="mb-10 md:mb-[96px]">
                        ...
                        <h3 class="brand-page-text text-white text-[24px] md:text-[64px] mb-1 md:mb-[7px] ml-[24px] md:ml-[64px] uppercase">Call2Care</h3>
                ...
                <a href="/branding/devronNexus" data-route="/branding/devronNexus" class="relative block">
                    <div class="mb-[71px] ">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 rounded-b-[19px] md:rounded-b-[68px]">
                            <h3 class="brand-page-text text-white text-[24px] md:text-[64px] mb-1 md:mb-[7px] ml-[24px] md:ml-[64px] uppercase ">Devron Nexus</h3>
